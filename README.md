...
Performance & Metrics
The model was evaluated on a hold-out test set of 246 MRI scans. To optimize for a medical triage use case, the confidence threshold is intentionally lowered to 0.05 to prioritize recall (minimizing false negatives) over precision.
